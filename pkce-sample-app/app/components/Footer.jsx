...
export default function Navbar(){
    ...
    <nav>
        <footer class="absolute inset-x-0 bottom-0 h-6 bg-black px-24 py-6 text-white">
            <p>Visit the IBM Security Verify Documentation Hub for more information about the Authorization code grant with the Proof Key of Code Exchange (PKCE) <span
            class="text-blue-600">
            <Link 
